    ...
    <div className="flex flex-1 items-center justify-center bg-surface-subtle px-6 py-10">
      <div className="w-full max-w-md rounded-2xl border border-status-error-border bg-status-error-bg p-6 text-center text-status-error-text">
        ...
        <button
          type="button"
          onClick={() => reset()}
          className="mt-4 inline-flex items-center justify-center rounded-lg border border-status-error-border bg-surface-default px-4 py-2 text-xs font-semibold text-status-error-text transition hover:bg-surface-subtle"
        >
          Try again
        </button>
      </div>

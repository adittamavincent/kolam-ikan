        ...
        <div className="border-b border-gray-200 p-4">
          ...
          {isEditing ? (
            <input
              ...
              onBlur={handleSave}
              className="text-sm text-gray-900 w-full outline-none border-b border-blue-500 pb-0.5 mt-1"
            />
          ) : (
            <p 
              className="text-sm text-gray-500 cursor-pointer hover:text-gray-700 mt-1 flex items-center gap-2 group"
              onClick={handleEdit}
            >

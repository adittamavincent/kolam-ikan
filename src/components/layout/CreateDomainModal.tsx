      ...
      >
        <div className="mt-2">
          <div className="relative">
            <input
              type="text"
              className={`block w-full border px-4 py-3 text-slate-800 placeholder-slate-500 focus: focus: transition-all ${
                error
          ...
          {error && (
            <div className="mt-3 flex items-center gap-2 text-rose-700 animate-fade-in">
